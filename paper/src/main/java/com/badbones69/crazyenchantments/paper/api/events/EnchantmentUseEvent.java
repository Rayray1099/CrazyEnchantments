...
public class EnchantmentUseEvent extends Event implements Cancellable {
    ...
    public EnchantmentUseEvent(final Player player, final CEnchantment enchantment, final ItemStack item) {
        this.player = player;
    ...
    public EnchantmentUseEvent(final Player player, final CEnchantments enchantments, final ItemStack item) {
        this.player = player;
