...
public class GKitzItem {
     ...
     * Make an empty gkit item.
     */
    public GKitzItem(final ItemBuilder itemBuilder) {
     ...
     */
    public void addCEEnchantment(final CEnchantment enchant, final int level) {
    ...
    public ItemStack build() {
        ...
        for (final Map.Entry<CEnchantment, Integer> enchantment : this.ceEnchantments.entrySet()) {
